...
import phamtuam.filemanager.source.controllers.network.NetworkFile;

import static phamtuam.filemanager.source.controllers.misc.MimeTypes.BASIC_MIME_TYPE;
import static phamtuam.filemanager.source.controllers.model.DocumentInfo.getCursorInt;
import static phamtuam.filemanager.source.controllers.network.NetworkConnection.SERVER;
import static phamtuam.filemanager.source.controllers.provider.ExplorerProvider.ConnectionColumns;

/**
 * Created by P.Tuan on 31/12/16.
 */
