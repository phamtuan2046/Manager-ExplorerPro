...
import phamtuam.filemanager.source.controllers.misc.OsCompat;
import phamtuam.filemanager.source.controllers.misc.Utils;
import phamtuam.filemanager.source.controllers.provider.DocumentsProvider;
import phamtuam.filemanager.source.controllers.provider.UsbStorageProvider;

import static phamtuam.filemanager.source.controllers.misc.SAFManager.DOCUMENT_AUTHORITY;
...
public final class DocumentsContract {
     ...
     * {@link phamtuam.filemanager.source.controllers.model.DocumentsContract.Document#COLUMN_DOCUMENT_ID}.
     *
    ...
    /**
     * Build URI representing the target {@link phamtuam.filemanager.source.controllers.model.DocumentsContract.Document#COLUMN_DOCUMENT_ID} in
     * a document provider. When queried, a provider will return a single row
     * with columns defined by {@link phamtuam.filemanager.source.controllers.model.DocumentsContract.Document}.
     *
     ...
     * Build URI representing the children of the target directory in a document
     * provider. When queried, a provider will return zero or more rows with
     * columns defined by {@link phamtuam.filemanager.source.controllers.model.DocumentsContract.Document}.
     * <p>
     ...
     *            directory with MIME type of {@link phamtuam.filemanager.source.controllers.model.DocumentsContract.Document#MIME_TYPE_DIR}.
     * @see android.content.Intent#ACTION_OPEN_DOCUMENT_TREE
     * @see android.provider.DocumentsProvider#isChildDocument(String, String)
    ...
    /**
     * Extract the {@link phamtuam.filemanager.source.controllers.model.DocumentsContract.Document#COLUMN_DOCUMENT_ID} from the given URI.
     *
    ...
    /**
     * Extract the via {@link phamtuam.filemanager.source.controllers.model.DocumentsContract.Document#COLUMN_DOCUMENT_ID} from the given URI.
     */
